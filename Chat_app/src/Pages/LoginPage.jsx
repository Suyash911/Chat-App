...
{currState==="Sign Up" ? (
  <p className='text-sm text-gray-600'> Already have an account? <span onClick={()=>{setCurrState("Login"); setIsDataSubmitted(true)}} className='font-medium text-violet-500 cursor-pointer'>Login Here</span></p>
):(
